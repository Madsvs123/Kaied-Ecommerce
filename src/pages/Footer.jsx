    ...
    >
      <div className="container">
        <Box
          display="grid"
          gap="1rem"
          gridTemplateColumns={isNonMobileScreen ? "repeat(3, 1fr)" : "100%"}
          mb="2rem"
        >
          <Box>
            <Typography
              variant={isNonMobileScreen ? "h2" : "h3"}
              fontWeight="700"
              sx={{ cursor: "pointer" }}
              mb=".7rem"
            ...
            <Typography variant="h5" fontWeight="500">
              We always aim to satisfy the customer and provide products that is
              best .
            </Typography>
          </Box>
          ...
          <MenuList sx={{ fontSize: ".8rem" }}>
            ...
            <ListItem>
              ...
              <Link
                ...
                color={palette.neutral.light}
                underline="none"
                href="mailto:ahmedamin12323@gmail.com"
              >
                ahmedamin12323@gmail.com
              </Link>
            </ListItem>
            <ListItem>
        ...
        >
          ...
          <Box mt={isNonMobileScreen ? "0" : "1rem"}>
            <IconButton>
              <LinkedIn
                sx={{ fontSize: "1.5rem", color: palette.neutral.light }}
              />
            </IconButton>
            <IconButton>
              <LinkedIn
